...
public abstract class Node {
	...
	/**
	 * Node accepts visitor. In other words node lets visitor visit him.
	 * 
	 * @param visitor
	 *            Visitor.
	 * @throws IOException
	 *             If there were errors while visiting node.
	 */

	public abstract void accept(INodeVisitor visitor) throws IOException;
